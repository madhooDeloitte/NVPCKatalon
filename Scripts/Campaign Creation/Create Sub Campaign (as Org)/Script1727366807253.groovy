...
WebUI.click(findTestObject('Create Campaign as Org/Page_giving.sg - admin Create new campaign/CampaignGoals/button__btn btn-icon - Plus'))
...
WebUI.verifyElementHasAttribute(findTestObject('Create sub campaign as org/Page_giving.sgEdit campaign/input_Start date_form-control OSFillParent _904945'), 
    'value', 0)
