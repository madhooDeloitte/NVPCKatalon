...
//Campaign title
String campaignTitle = 'Datatagscript3private'

//Campaign goals
String campaignGoal = '1022'
...
WebUI.click(findTestObject('Create Campaign as Org/Page_giving.sg - admin Create new campaign/input_Switch_Private'))
