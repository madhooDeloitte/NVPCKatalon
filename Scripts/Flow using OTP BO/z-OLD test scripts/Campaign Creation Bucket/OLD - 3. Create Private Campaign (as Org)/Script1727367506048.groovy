...
WebUI.doubleClick(findTestObject('Object Repository/Page_giving.sg - admin Create new campaign/i_Start date_icon fa fa-calendar fa-1x'))
...
WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create new campaign/a_Environmental protection and sustainability'))
...
WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create new campaign/input_View members_b3-b28-Switch_Private2'))
