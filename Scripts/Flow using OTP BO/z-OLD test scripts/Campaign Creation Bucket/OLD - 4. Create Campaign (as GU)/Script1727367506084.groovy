...
WebUI.click(findTestObject('Object Repository/Page_giving.sgLogin/input_If the account exists, you will recei_fe0d50'))
...
WebUI.click(findTestObject('Page_giving.sg - admin Create new campaign/div_Select'))

WebUI.click(findTestObject('Page_giving.sg - admin Create new campaign/span_SCAPE CO. LTD'))
...
WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create new campaign/i_Start date_icon fa fa-calendar fa-1x'))
...
WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create new campaign/a_Arts, culture and heritage'))
...
WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create new campaign/span_23'))

WebUI.click(findTestObject('Page_giving.sgEdit campaign/input_End_Test_3'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create new campaign/span_28'))
