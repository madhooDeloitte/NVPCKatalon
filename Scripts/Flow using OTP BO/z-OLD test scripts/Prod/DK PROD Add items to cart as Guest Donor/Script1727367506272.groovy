...
WebUI.click(findTestObject('Page_giving.sgDonate/div_CampaignDonation'))
...
WebUI.click(findTestObject('div_spread the love our world needsTania for Children-At-Risk Empowerment Association (CARE Singapore)368 raised of 28,0005 donors'))
