...
WebUI.verifyElementText(findTestObject('Page_giving.sgCheckout cart/span_Donation amount should not exceed 10,000'), 'Donation amount should not exceed $10,000')
...
WebUI.verifyElementText(findTestObject('Object Repository/Page_giving.sgCheckout cart/span_Donation amount should not exceed 10,000_1_2'), 
    'Donation amount should not exceed $10,000')
