...
WebUI.click(findTestObject('Page_giving.sgEdit opportunity (1)/button_Create Opportunity'))
...
WebUI.click(findTestObject('Object Repository/Causes 2 Chips/a_Causes Chip 1'))

WebUI.click(findTestObject('Causes 2 Chips/a_Causes Chip 2'))

WebUI.click(findTestObject('Object Repository/Page_giving.sgEdit opportunity (1)/a_SuitableFor Chip 1'))

WebUI.click(findTestObject('Object Repository/Page_giving.sgEdit opportunity (1)/button_Next_1'))

WebUI.click(findTestObject('Object Repository/Page_giving.sgEdit opportunity (1)/button_Next_1_2'))

WebUI.click(findTestObject('Page_giving.sg - admin Create opportunity (2)/div_ProjectBased'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/input_Start date'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/span_28'))

WebUI.click(findTestObject('Page_giving.sg - admin Create opportunity (2)/input_End date'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/span_11'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/i_hours_icon increase'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/i_hours_icon increase'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/i_hours_icon decrease'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/div_ProjectFrequency'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/div_Weekly'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/div_ProjectFrequency'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/div_Fortnightly'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/div_ProjectFrequency'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/div_Monthly'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (2)/input_Opportunity end date radio'))

WebUI.click(findTestObject('Page_giving.sg - admin Create opportunity (2)/div_RegistrationEnds'))

WebUI.click(findTestObject('Page_giving.sg - admin Create opportunity (2)/div_One week before'))

WebUI.click(findTestObject('Page_giving.sg - admin Create opportunity (2)/div_RegistrationEnds'))

WebUI.click(findTestObject('Page_giving.sg - admin Create opportunity (2)/div_One day before'))
