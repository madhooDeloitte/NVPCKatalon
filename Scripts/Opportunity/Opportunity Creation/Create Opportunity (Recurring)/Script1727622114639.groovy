...
WebUI.click(findTestObject('Page_giving.sgEdit opportunity (1)/div_Recurring'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/input_Start date'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/span_30'))

WebUI.click(findTestObject('Page_giving.sg - admin Create opportunity (3)/input_End date'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/span_12'))

WebUI.click(findTestObject('Pick hour/input_Start time'))

'Input start and end time'
WebUI.delay(40)

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/div_Please select'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/div_Weekly'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/input_Monday'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/input_Tuesday'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/input_Wednesday'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/input_Thursday'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/input_Friday'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/input_Saturday'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/input_Sunday'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/div_Please select'))

WebUI.click(findTestObject('Object Repository/Page_giving.sg - admin Create opportunity (3)/div_Daily'))
