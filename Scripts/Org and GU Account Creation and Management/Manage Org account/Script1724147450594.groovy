...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_Marriott International Serve 360/div_AboutToday, business plays an increasin_0214bf'), 
    0)
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Page_giving.sg - admin Home/span_Your August overview'), 0)
