...
String userEmail = 'rajeev@marriott.dk.dev'
...
WebUI.scrollToElement(findTestObject('Object Repository/Page_giving.sgSG60 SHARE/span_give_other_amounts'), 3)

WebUI.delay(3)

'verify missing recurring donation option'
