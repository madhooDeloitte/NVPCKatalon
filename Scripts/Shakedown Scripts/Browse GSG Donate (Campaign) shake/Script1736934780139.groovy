...
WebUI.takeFullPageScreenshotAsCheckpoint('2 donate page')
...
'search charity'
WebUI.takeFullPageScreenshotAsCheckpoint('3 charity search results')
...
WebUI.takeFullPageScreenshotAsCheckpoint('4 search another charity')
...
'1.5 verify searched campaign has default image when no image shown'
WebUI.takeFullPageScreenshotAsCheckpoint('5 verify default image')
...
WebUI.takeFullPageScreenshotAsCheckpoint('6 verify search results')
...
WebUI.takeFullPageScreenshotAsCheckpoint('7 verify back to default page')
...
WebUI.takeFullPageScreenshotAsCheckpoint('8 causes pill works')
...
WebUI.takeFullPageScreenshotAsCheckpoint('9 tax deductible pill works')
...
WebUI.takeFullPageScreenshotAsCheckpoint('10 campaign type pill works')
...
WebUI.takeFullPageScreenshotAsCheckpoint('11 underserved pill works')

WebUI.click(findTestObject('Object Repository/Page_giving.sgDonate -/div_Sort Popularity'))

WebUI.delay(3)

WebUI.takeFullPageScreenshotAsCheckpoint('12 popularity works')
...
WebUI.takeFullPageScreenshotAsCheckpoint('13 verify animal cause selected')
...
WebUI.takeScreenshotAsCheckpoint('14 clicked all campaign')
...
WebUI.takeScreenshotAsCheckpoint('15 public campaign clicked')
...
WebUI.takeScreenshotAsCheckpoint('16 private campaign clicked')
...
WebUI.takeFullPageScreenshotAsCheckpoint('17 tax-deductible selected')
...
'enable under served'
WebUI.takeFullPageScreenshotAsCheckpoint('18 underserved selected')
...
WebUI.takeFullPageScreenshotAsCheckpoint('19 clear all works')
...
WebUI.takeFullPageScreenshotAsCheckpoint('20 Youxx search results')
...
WebUI.takeFullPageScreenshotAsCheckpoint('21 Yuoth search results')
...
WebUI.takeFullPageScreenshotAsCheckpoint('22 Youth search results')
...
WebUI.takeFullPageScreenshotAsCheckpoint('23 popularity filter')
...
WebUI.takeFullPageScreenshotAsCheckpoint('24 latest filter')
...
WebUI.takeFullPageScreenshotAsCheckpoint('25 ending soon filter')
...
WebUI.takeFullPageScreenshotAsCheckpoint('26 reaching goals filter')
...
WebUI.takeFullPageScreenshotAsCheckpoint('27 relevance filter')
