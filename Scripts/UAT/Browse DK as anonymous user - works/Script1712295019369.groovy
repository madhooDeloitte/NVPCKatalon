...
WebUI.click(findTestObject('Object Repository/Page_giving.sgCampaign detail - test campai_a1e508/span_Volunteer'))

WebUI.scrollToElement(findTestObject('Page_giving.sgVolunteer/img_Results per page_b2-l3-625_0-b42-b1-Con_8a9158'), 0)

WebUI.takeScreenshotAsCheckpoint('Volunteer Listings')

WebUI.click(findTestObject('Object Repository/Page_giving.sgVolunteer/img_Results per page_b2-l3-625_0-b42-b1-Con_8a9158'))
