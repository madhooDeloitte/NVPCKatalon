...
not_run: WebUI.scrollToElement(findTestObject('Object Repository/Page_giving.sgVolunteer/First Div_Volunteer Page'), 
    0)

WebUI.click(findTestObject('Object Repository/Page_giving.sgVolunteer/img_Results per page_b2-l3-1234_0-b42-b1-Co_491c60'))
